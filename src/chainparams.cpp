...
{
    const char* pszTimestamp = "far away across the field the tolling of the iron bell";
    const CScript genesisOutputScript = CScript() << ParseHex("04497cad050454aed32f86435d02d7bbf8c1b2391f1b8cb27fed190ea286b21fcb338e234f4d69c306cddffcb8466705a595efbecefe14364cb4a09b80ebecea24") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1668532854, 942240, 0x1e0ffff0, 1, 50 * COIN);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1812394, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd273061d022dba25bdd1fa27e21ee3991bd65ede7a6955882b68ebe17d310dba"));
        assert(genesis.hashMerkleRoot == uint256S("0x580584b90c5f64083cb3609c5b0a3cf2a9cf925878e39e7941e91f4b300528ec"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.push_back(CDNSSeedData("potrerotools.com", "testnet-seed.potrerotools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.potrero.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1bb7c187917433108f0a87aff7ef15e63a620d2116e8fddb44893f2091ea5830"));
        assert(genesis.hashMerkleRoot == uint256S("0x580584b90c5f64083cb3609c5b0a3cf2a9cf925878e39e7941e91f4b300528ec"));
