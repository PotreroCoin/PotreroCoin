...
const char * const BITCOIN_CONF_FILENAME = "potrero.conf";
const char * const BITCOIN_PID_FILENAME = "potrero.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Potrero";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Potrero";
#else
    // Unix
    return pathRet / ".potrero";
#endif
#endif
}
