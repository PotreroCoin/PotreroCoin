...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s potrero-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  potrero-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded potrero transaction") + "\n" +
              "  potrero-tx [options] -create [commands]   " + _("Create hex-encoded potrero transaction") + "\n" +
              "\n";
