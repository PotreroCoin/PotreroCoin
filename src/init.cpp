...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/PotreroCoin/PotreroCoin>";
    const std::string URL_WEBSITE = "<https://github.com/PotreroCoin/PotreroCoin/blob/main/README.md>";
