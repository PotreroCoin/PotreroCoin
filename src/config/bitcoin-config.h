...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Potrero Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Potrero Core"
...
#define PACKAGE_BUGREPORT "https://github.com/potrero-project/potrero/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Potrero Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Potrero Core 0.15.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "potrero"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://potrero.org/"
