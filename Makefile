...
ACLOCAL = ${SHELL} '/data/git/PotreroCoin/build-aux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} '/data/git/PotreroCoin/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/data/git/PotreroCoin/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/data/git/PotreroCoin/build-aux/missing' automake-1.16
AWK = mawk
BDB_CFLAGS = -I/data/git/PotreroCoin/db4/include
BDB_CPPFLAGS = -I/data/git/PotreroCoin/db4/include
BDB_LIBS = -L/data/git/PotreroCoin/db4/lib -ldb_cxx-4.8
...
CTAGS = ctags
CUDA_HOME = /lib
CUDA_LIB_DIR = /lib/x86_64-linux-gnu
CXX = g++ -std=c++11
CXXCPP = g++ -std=c++11 -E
...
MAINT = 
MAKEINFO = ${SHELL} '/data/git/PotreroCoin/build-aux/missing' makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_STRING = Potrero Core 0.15.1
...
ZMQ_LIBS = -lzmq 
abs_builddir = /data/git/PotreroCoin
abs_srcdir = /data/git/PotreroCoin
abs_top_builddir = /data/git/PotreroCoin
abs_top_srcdir = /data/git/PotreroCoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /data/git/PotreroCoin/build-aux/install-sh
