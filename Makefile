...
ACLOCAL = ${SHELL} /data/git/potrero/PotreroCoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /data/git/potrero/PotreroCoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /data/git/potrero/PotreroCoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /data/git/potrero/PotreroCoin/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /data/git/potrero/PotreroCoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /data/git/potrero/PotreroCoin
abs_srcdir = /data/git/potrero/PotreroCoin
abs_top_builddir = /data/git/potrero/PotreroCoin
abs_top_srcdir = /data/git/potrero/PotreroCoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /data/git/potrero/PotreroCoin/build-aux/install-sh
